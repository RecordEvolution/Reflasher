...
export default {
  ...
  authentication_explanation:
    'To allow EgGen to erase your selected drives and overwrite any partitions on these, please enter your admin password for this computer in the field below.',
  ...
  please_ensure_environment_variables:
    'In order to use the EgGen, please ensure that this environment variable has been properly defined. | In order to use the EgGen, please ensure that these environment variables have been properly defined.',
  exit_reflasher: 'Exit EgGen',
  ...
  update: {
    announce: 'New EgGen release available',
    download: 'Downloading EgGen release',
